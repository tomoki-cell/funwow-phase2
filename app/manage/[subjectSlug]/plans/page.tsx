...
const initialPlans: PlanDef[] = [
  ...
  },
  {
    ...
    price: 12000,
    billingCycle: 'annual',
    description: '会員限定コンテンツへのフルアクセスと展示入場特典付きの個人サポータープラン。',
    benefits: [
      '会員限定投稿の閲覧',
      '会員限定イベントへの参加（先行申込）',
      '展示入場 年2回無料',
  ...
  },
  {
    ...
    price: 1200000,
    billingCycle: 'annual',
    description: '最大10名まで利用可能な法人向けサポータープラン。社員のアートエンゲージメント促進に。',
    benefits: [
      '10名まで会員限定コンテンツアクセス',
      '会員限定イベントへの参加（10名・先行申込）',
      '展示入場 10名まで無制限',
      'Funwow月1,000pt付与（10名分）',
      '法人名クレジット掲載（展示フライヤー等）',
      '社員向けギャラリーツアー 年1回',
      '請求書払い・領収書発行対応',
      '専任担当者によるサポート',
  ...
  },
  {
    ...
    price: 120000,
    billingCycle: 'annual',
    description: '深いアートとの関わりを求めるコレクター・パトロン向けの最上位個人プラン。',
    benefits: [
      '全コンテンツ・全イベントへのフルアクセス',
      'プレビュー最優先招待（内覧会・VIP枠）',
      'アーティストとの個別交流機会 年2回',
      '作品購入の優先案内・相談対応',
      '展示入場 無制限',
  ...
  },
  {
    ...
    price: 4800000,
    billingCycle: 'annual',
    description: '最大50名対応の法人メインスポンサープラン。展示協賛・社員アートプログラム・VIP招待を包含。',
    benefits: [
      '50名まで全コンテンツ・全イベントへのフルアクセス',
      '展示メインスポンサークレジット（会場・フライヤー・ウェブ）',
      'プレスリリース共同発信・メディア露出サポート',
      'プライベートビューイング 年4回（最大20名）',
      'アーティストとの特別プログラム企画・実施',
      'コレクター向け作品購入相談・優先案内',
      'VIPイベント招待 年12回（各5名まで）',
      '社員向けアートプログラム提供（年2回）',
      'Funwow月1,000pt付与（50名分）',
      '専任コンシェルジュ・窓口担当',
      '請求書払い・税務書類対応',
    ],
    isActive: true,
